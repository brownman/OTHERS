...
static void filter_metal(context_t *cx)
{
    ...
    {
        CACA_LIGHTRED, CACA_YELLOW, CACA_WHITE,         CACA_LIGHTRED,  CACA_WHITE, CACA_LIGHTRED,
    };
...
static void filter_gay(context_t *cx)
{
    static unsigned char const rainbow[] =
    {
       ...
       //
        CACA_LIGHTGREEN, CACA_GREEN, CACA_WHITE,CACA_LIGHTGREEN,  CACA_WHITE, CACA_LIGHTCYAN
    };
    unsigned int x, y, w, h;
